...
import { Capability, CategoryEnum, DatatypeEnum } from '@tapis/tapis-typescript-systems';
...
const JobCapabilitiesField: React.FC<JobCapabilitiesFieldProps> = ({ item, index, remove }) => {
  return (
    <>
      <Collapse
        open={!item}
